...
class usuarios_CO
{
    ...
    function agregar()
    {
        ...
        $arreglo_usuarios=$usuarios_MO->seleccionarDocumento($usua_documento);
        if($arreglo_usuarios)
        {
            $arreglo_respuesta = [
                "estado"=>"ERROR",
        ...
        /*Fin saber si está duplicado el documento*/
         ...
         $arreglo_usuarios=$usuarios_MO->seleccionarCorreo($usua_correo);
         if($arreglo_usuarios)
         {
             $arreglo_respuesta = [
                 "estado"=>"ERROR",
         ...
         $arreglo_usuarios=$usuarios_MO->seleccionarUsername($usua_username);
         if($arreglo_usuarios)
         {
             $arreglo_respuesta = [
                 "estado"=>"ERROR",
        ...
        $usuarios_MO->agregar($usua_nombre,$usua_correo,$usua_username,$usua_documento);
    ...
    function actualizarUsuarios()
    {
        ...
        /*Fin saber se supera número de carácteres*/
         ...
         /*Saber si está duplicado el correo*/
         $arreglo_usuarios=$usuarios_MO->seleccionarCorreo($usua_correo);
         foreach($arreglo_usuarios as $indices=>$objeto_datos)
        {
        ...
        $usuarios_MO->actualizarUsuarios($usua_id,$usua_nombre,$usua_correo);
